 ...
 * 
 * Usage:
 * $verify = new WD_Envato_Verify( 'YOUR API KEY' );
 * echo $verify->verify_purchase( 'BUYER PURCHASE CODE' ); //The class returns a boolean value. TRUE if the code is valid or FALSE if it is not.
 */
if (!class_exists('WD_Envato_Verify')) {
    class WD_Envato_Verify {
