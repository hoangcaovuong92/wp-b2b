<?php
if (!class_exists('WD_Footers_Post_Type')) {
	class WD_Footers_Post_Type extends WD_Package_Metabox{
		/**
		...
		protected $post_type 				= 'wd_footer';
		protected $post_type_single_name 	= 'Footers';
		protected $post_type_multiple_name 	= 'Footers';
		protected $post_type_display_name 	= 'Footers';
		...
		protected $taxonomy 				= 'wd_footer_group';
		protected $taxonomy_single_name		= 'Footers Group';
		...
		protected function constant(){
			define('WD_FOOTERS_BASE'		,   plugin_dir_path( __FILE__ ) );
			define('WD_FOOTERS_BASE_URI'	,   plugins_url( '', __FILE__ ) );
		}
	...
	WD_Footers_Post_Type::get_instance();  // Start an instance of the plugin class 
}