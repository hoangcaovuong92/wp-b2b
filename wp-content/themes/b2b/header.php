	...
	<body <?php body_class(); ?>>
		...
		<div class="body-wrapper">
			<header id="header" class="header">
				<div class="wd-header-content-wrap wd-header-desktop wd-desktop-screen">
					<?php 
					/**
					 * wd_hook_header_init_action hook.
					 *
					 * @hooked html_header_init - 5
					 */
					do_action('wd_hook_header_init_action'); ?>
				</div>	
				...
				<div class="wd-stickymenu-placeholder"></div>
				<div id="wd-header-main-breadcrumb">
					<?php
					/**
					 * wd_hook_init_breadcrumbs hook.
					 *
					 * @hooked init_breadcrumbs - 5
					 */ 
					do_action('wd_hook_init_breadcrumbs'); ?>
				</div>
			</header> <!-- END HEADER  -->