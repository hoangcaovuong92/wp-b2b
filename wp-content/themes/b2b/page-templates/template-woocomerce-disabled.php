<?php
/*
Template Name: Woocommerce Disabled Template
*/
get_header( 'shop' ); 
 ...
 * var: sidebar_right 
 */
extract(apply_filters('wd_filter_get_data_package', 'woocommerce-page' )); 
...
do_action('wd_hook_before_main_content'); ?>
	...
	<?php 
	/**
	 * wd_hook_banner_woocommerce_template_before hook.
	 */
	do_action('wd_hook_banner_woocommerce_template_before'); ?>

	<div class="wd-woocommerce-page wd-main-content">
		<!-- Left Content -->
	...
	<?php 
	/**
	 * wd_hook_banner_woocommerce_template_after hook.
	 */
	do_action('wd_hook_banner_woocommerce_template_after'); ?>
